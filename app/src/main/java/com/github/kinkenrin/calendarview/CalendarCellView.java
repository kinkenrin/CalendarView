...
/**
 * Created by jinxl on 2017/8/28.
 */
public class CalendarCellView extends FrameLayout {
    private static final int[] STATE_SELECTABLE = {
            R.attr.cv_state_selectable
    };
    private static final int[] STATE_CURRENT_MONTH = {
            R.attr.cv_state_current_month
    };
    private static final int[] STATE_TODAY = {
            R.attr.cv_state_today
    };
    private static final int[] STATE_HIGHLIGHTED = {
            R.attr.cv_state_highlighted
    };
    private static final int[] STATE_RANGE_FIRST = {
            R.attr.cv_state_range_first
    };
    private static final int[] STATE_RANGE_MIDDLE = {
            R.attr.cv_state_range_middle
    };
    private static final int[] STATE_RANGE_LAST = {
            R.attr.cv_state_range_last
    };
